            ...
            child: Column(
              ...
              children: [
                ...
                _buildSection(
                    'Tu historia',
                    _buildTextField(
                        _storyController, 'Cuentanos sobre ti ...', 500),
                    titleSpacing),
                SizedBox(height: sectionSpacing),
                _buildSection(
                    'Complexión',
                ...
                _buildSection(
                    'Lo que busco',
                    _buildTextField(_seekingController,
                        'Cuéntanos ¿Qué buscas en la app?', 500),
                    titleSpacing),
                SizedBox(height: sectionSpacing),
                Text('HÁBITOS',
                ...
                _buildSection(
                    ...
                    _buildSingleRowSelection(
                        ...
                        onSelect: (option) =>
                            setState(() => _drinkingHabit = option),
                        buttonHeight: buttonHeight),
                    titleSpacing),
                SizedBox(height: sectionSpacing),
                _buildSection(
